...
|---|---|---:|---:|---|---|
| `wechat_channels_portrait` | 微信视频号竖版/主页兼容 | 1080×1260 | 6:7 | upper real scene 60%, lower outline info 40% | center 80% width × 78% height; keep title and face away from top/bottom 11% |
| `wechat_channels_landscape` | 微信视频号横版 | 1920×1080 | 16:9 | left real scene 60%, right outline info 40% | center 76% width × 78% height; make the 6:7 center crop understandable |
| `toutiao_landscape` | 今日头条横版视频 | 1920×1080 | 16:9 | left real scene 60%, right outline info 40% | center 82% width × 78% height; reserve edge space for card crops |
| `bilibili_landscape` | B站普通横版视频 | 1920×1080 | 16:9 | left real scene 60%, right outline info 40% | center 82% width × 80% height; keep title within two lines |
| `bilibili_legacy_16_10` | B站旧式/兼容封面画布 | 1146×717 | about 16:10 | left real scene 60%, right outline info 40% | center 82% width × 80% height; check 16:9 crop survival |
| `douyin_portrait` | 抖音竖屏视频 | 1080×1920 | 9:16 | upper real scene 60%, lower outline info 40% | center 82% width; avoid top 12%, bottom 20%, and right 12% UI risk |
| `douyin_grid_cover` | 抖音主页封面导出 | 1080×1440 | 3:4 | upper real scene 60%, lower outline info 40% | center 82% width × 80% height; preserve center square/grid crop |
| `kuaishou_portrait` | 快手竖屏视频 | 1080×1920 | 9:16 | upper real scene 60%, lower outline info 40% | center 82% width; avoid top 12%, bottom 20%, and right 12% UI risk |
| `xiaohongshu_portrait` | 小红书视频/笔记封面 | 1080×1440 | 3:4 | upper real scene 60%, lower outline info 40% | center 84% width × 82% height; keep face and title in upper-middle core |
| `xigua_landscape` | 西瓜视频横版 | 1920×1080 | 16:9 | left real scene 60%, right outline info 40% | center 82% width × 78% height |
| `youtube_landscape` | YouTube thumbnail | 1280×720 | 16:9 | left real scene 60%, right outline info 40% | center 86% width × 82% height; use very short text |
...
- Place the enlarged realistic scene in the left 60% and the low-density white micro-3D outline in the right 40%.
...
- Place the enlarged realistic scene in the upper 60% and the low-density white micro-3D outline in the lower 40%.
